  ...
  return (
    <div className="min-h-screen">
      ...
      <Grid container spacing={2} className="mb-6">
        <Grid size={{ md: 3 }}>
          <Card className="shadow-lg" sx={{p:0}}>
            <CardContent className="flex items-center"  sx={{height:"auto",}}>
              <div className="bg-blue-100 h-16 w-16 mr-4 flex items-center justify-center">
                <ThumbUpAltIcon className="text-blue-500" />
              </div>
              <div>
                <Typography variant="" className="text-gray-600">
                  Total Leads
                </Typography>
        ...
        <Grid size={{ md: 3 }}>
          <Card className="shadow-lg">
            <CardContent className="flex items-center"  sx={{height:"auto"}}>
              <div className="bg-green-100 h-16 w-16 mr-4 flex items-center justify-center">
        ...
        <Grid size={{ md: 3 }}>
          <Card className="shadow-lg">
            <CardContent className="flex items-center"  sx={{height:"auto"}}>
              <div className="bg-yellow-100 h-16 w-16 mr-4 flex items-center justify-center">
        ...
        <Grid size={{ md: 3 }}>
          <Card className="shadow-lg">
            <CardContent className="flex items-center" sx={{height:"auto"}}>
              <div className="bg-teal-100 h-16 w-16 mr-4 flex items-center justify-center">
              ...
              <div>
                ...
                <Typography variant="h4" className="font-bold text-teal-500">
                  1,120
                </Typography>
              </div>
            </CardContent>
          ...
          <Card className="shadow-lg">
            <CardContent>
              ...
              <BarChart
                ...
                series={[
                  { dataKey: "value", label: "Quantity", color: "#ef4444" },
                ]}
                height={300}
                sx={{
                  [`& .${barElementClasses.root}`]: {
